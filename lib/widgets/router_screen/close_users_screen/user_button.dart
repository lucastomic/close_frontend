...
class UserButton extends StatelessWidget {
  ...
  const UserButton(User user, ImageQualityReducer qualityReducer, IMessageService messageService) : _user = user, _qualityReducer = qualityReducer, _messageService = messageService;
